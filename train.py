...
from loras import LinearWithLoRA
...
# 模型测试
def test(base_model, ckpt_name, device, test_loader, dataset_name):
...
class CFG:
    ...
    num_epochs_start=0
    last_epoch=-1
    last_checkpoint='' #'./models/model-1.0_e1-0.94'
...
if __name__ == "__main__":
    ...
    _, test_acc = test(model, best_ckpt_name + ".ckpt", device, test_loader, "Test")
